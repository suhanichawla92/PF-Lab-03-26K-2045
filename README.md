...
Learn the basic syntax and structure of Markdown.
Practice fundamental C data types and format specifiers.
Practice input and output functions in C.
...
"Practice is the key to improving programming skills."

Completed Tasks
 Created the GitHub repository
 Created and edited the README.md file
 Learned the basics of GitHub and Markdown
 Prepared the repository for the lab tasks
